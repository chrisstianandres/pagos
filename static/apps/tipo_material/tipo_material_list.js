  ...
  datatable  = $("#datatable").DataTable({
    ...
    $('#datatable tbody')
        .on('click', 'a[rel="del"]', function () {
            ...
            save_estado('Alerta',
                '/tipo_mat/nuevo', 'Esta seguro que desea eliminar este tipo de material?', parametros,
                function () {
                    menssaje_ok('Exito!', 'Exito al eliminar este tipo de material!', 'far fa-smile-wink', function () {
    ...
    $('#nuevo').on('click', function () {
        $('#exampleModalLabel').html('<i class="fas fa-plus"></i>&nbsp;Nuevo registro de un tipo de material');
        $('#Modal').modal('show');
        action = 'add';
        pk = '';
    });
