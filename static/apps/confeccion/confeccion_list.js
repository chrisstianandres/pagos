...
$(function () {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var pdf = '<a type="button" href= "/confeccion/printpdf/' + data + '" rel="pdf" class="btn btn-primary btn-sm btn-round" style="color: white" data-toggle="tooltip" title="Reporte PDF"><i class="fa fa-file-pdf"></i></a>';
    ...
    $('#nuevo').on('click', function () {
        window.location.replace('/confeccion/nuevo')
