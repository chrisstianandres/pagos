...
urlpatterns = [
    ...
    path('inventario/', include('apps.inventario_productos.urls', namespace='inventario')),
    ...
    path('asig_recurso/', include('apps.asignar_recursos.urls', namespace='asig_recurso')),
